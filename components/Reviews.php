...
class Reviews extends ComponentBase
{
    ...
    public function defineProperties()
    {
        return [
            ...
            'reviewsPerPage' => [
                'title'             => 'martinimultimedia.press::lang.settings.reviews_per_page',
                'type'              => 'string',
                'validationPattern' => '^[0-9]+$',
                'validationMessage' => 'martinimultimedia.press::lang.settings.reviews_per_page_validation',
                'default'           => '10',
            ],
            'noReviewsMessage' => [
                'title'        => 'martinimultimedia.press::lang.settings.no_reviews',
                'description'  => 'martinimultimedia.press::lang.settings.no_reviews_description',
                'type'         => 'string',
                'default'      => 'No posts found',
                'showExternalParam' => false
            ],
            'sortOrder' => [
                'title'       => 'martinimultimedia.press::lang.settings.reviews_order',
                'description' => 'martinimultimedia.press::lang.settings.reviews_order_description',
                'type'        => 'dropdown',
                'default'     => 'published_at desc'
            ],
            'reviewPage' => [
                'title'       => 'martinimultimedia.press::lang.settings.review_page',
                'description' => 'martinimultimedia.press::lang.settings.review_page_description',
                'type'        => 'dropdown',
                'default'     => 'blog/post',
                'group'       => 'Links',
            ]
